...
pl.plot([- 1.5,    0,  1.5,  1.5, -1 , - 1.5 , - 1.5],
        [   -1,  1.5,  1.5, -  0, -1.5, - 1.5 , - 1], 'b', linewidth=2)
...
pl.fill_between([ -1,  1.5],
                    [ -1.5, 0],
                    [  -1.5,  -1.5],
                    color='.9')
pl.text( -.3, .5, 'Convex Region', size = 15)
pl.text( -1, 1.3, '$Constraint$', size = 15)
pl.text( 0, -1.1, '$Constraint$', size = 15)
